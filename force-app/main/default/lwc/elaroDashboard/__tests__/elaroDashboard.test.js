/**
 * Jest tests for elaroDashboard LWC component
 *
 * Tests cover:
 * - Component rendering
...
import ElaroDashboard from "c/elaroDashboard";
...
jest.mock(
  "@salesforce/apex/ElaroDashboardController.getAuditPackages",
  () => ({
...
describe("c-elaro-dashboard", () => {
  ...
  async function createComponent() {
    const element = createElement("c-elaro-dashboard", {
      is: ElaroDashboard,
    });
  ...
  describe("Error Handling", () => {
    it("handles wire adapter error gracefully", async () => {
      ...
      expect(element.shadowRoot.querySelector(".elaro-dashboard")).not.toBeNull();
    });
  });
});
