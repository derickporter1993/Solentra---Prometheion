# Prometheion Analytics - Quick Start Guide
...
```bash
./scripts/deploy-prometheion-analytics.sh [org-alias]
```

### Option 2: Manual Deployment
```bash
# Deploy all controllers
sf project deploy start --source-dir force-app/main/default/classes/Prometheion*Controller*

# Deploy all test classes
sf project deploy start --source-dir force-app/main/default/classes/Prometheion*ControllerTest*
...
2. Drag **Prometheion Executive KPI Dashboard** from Custom components
3. Save and activate the page

### 3. Test Dynamic Report Builder (3 minutes)

1. Add **Prometheion Dynamic Report Builder** to a page
...
- **Controllers:** `force-app/main/default/classes/Prometheion*Controller.cls`
- **LWC Components:** `force-app/main/default/lwc/prometheion*`
- **Tests:** `force-app/main/default/classes/Prometheion*ControllerTest.cls`
- **Documentation:** `docs/PROMETHEION_ANALYTICS_IMPLEMENTATION_PLAN.md`

## Support

For detailed information, see the full implementation plan:
`docs/PROMETHEION_ANALYTICS_IMPLEMENTATION_PLAN.md`
